...
class Transfer(BasePage):
    ...
    def Create_validation_check_Transfercprofile(self, profilename, validprefix, validextention, remark, overwrite, valuechecksumval, deleteafterfailure, transferprotocol, oprationtypeval):
        try:
            ...
            print(f"Error during creating transfer profile: {e}")
            return None

    def Update_Transfercprofile(self, profilename, validprefix, validextention, remark, overwrite, valuechecksumval, deleteafterfailure, transferprotocol, oprationtypeval, updateprofilename):
        try:
            self.do_click(self.GOTOPROFILE)
            self.hard_refresh()
            self.hard_refresh()
            ...
            print(f"Error during updating transfer profile: {e}")
            return None
    ...
    def Delete_Transferprofile(self, profilename):
        try:
            ...
            print(f"Error during deleting transfer profile: {e}")
            return None
